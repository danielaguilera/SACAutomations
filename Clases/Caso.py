...
class Caso:
    def __init__(self, idMapsa: int, nombreEstado: str, fechaAsignado: datetime, bsecs: str | int, apellidoDeudor: str, nombreDeudor: str, rutDeudor: str, idCliente: int, nombreCliente: str, factura: str = ''):
